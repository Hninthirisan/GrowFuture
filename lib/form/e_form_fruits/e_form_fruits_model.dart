...
class EFormFruitsModel extends FlutterFlowModel {
  ...
  // State field(s) for fruitMultiChoice widget.
  List<String>? fruitMultiChoiceValues;
  FormFieldController<List<String>>? fruitMultiChoiceValueController;
