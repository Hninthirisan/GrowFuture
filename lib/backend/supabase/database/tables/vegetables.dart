...
class VegetablesTable extends SupabaseTable<VegetablesRow> {
  @override
  String get tableName => 'vegetables';

  @override
  VegetablesRow createRow(Map<String, dynamic> data) => VegetablesRow(data);
}

class VegetablesRow extends SupabaseDataRow {
  VegetablesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => VegetablesTable();

  String get vegetableid => getField<String>('vegetableid')!;
  set vegetableid(String value) => setField<String>('vegetableid', value);
