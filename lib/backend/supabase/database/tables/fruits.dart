...
class FruitsTable extends SupabaseTable<FruitsRow> {
  @override
  String get tableName => 'fruits';

  @override
  FruitsRow createRow(Map<String, dynamic> data) => FruitsRow(data);
}

class FruitsRow extends SupabaseDataRow {
  FruitsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => FruitsTable();

  String get fruitid => getField<String>('fruitid')!;
  set fruitid(String value) => setField<String>('fruitid', value);
