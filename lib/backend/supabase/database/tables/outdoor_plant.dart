...
class OutdoorPlantTable extends SupabaseTable<OutdoorPlantRow> {
  @override
  String get tableName => 'outdoorPlant';

  @override
  OutdoorPlantRow createRow(Map<String, dynamic> data) => OutdoorPlantRow(data);
}

class OutdoorPlantRow extends SupabaseDataRow {
  OutdoorPlantRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => OutdoorPlantTable();

  String get outdoorplantid => getField<String>('outdoorplantid')!;
  set outdoorplantid(String value) => setField<String>('outdoorplantid', value);
