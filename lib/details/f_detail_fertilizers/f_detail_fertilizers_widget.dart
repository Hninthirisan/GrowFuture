...
import 'f_detail_fertilizers_model.dart';
export 'f_detail_fertilizers_model.dart';

class FDetailFertilizersWidget extends StatefulWidget {
  const FDetailFertilizersWidget({
    Key? key,
    this.id,
  }) : super(key: key);
  ...
  @override
  _FDetailFertilizersWidgetState createState() =>
      _FDetailFertilizersWidgetState();
}

class _FDetailFertilizersWidgetState extends State<FDetailFertilizersWidget>
    with TickerProviderStateMixin {
  late FDetailFertilizersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FDetailFertilizersModel());
